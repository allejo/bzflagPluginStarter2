...
description: This event is called every time packets are sent to the server
name: bz_eMsgDebugEvent
parameters:
- dataType: char[2]
...
- dataType: size_t
  ...
  name: len
- dataType: char*
  description: The actual message telling the server what the data contains, based
    on the code data.
  name: msg
- dataType: bool
